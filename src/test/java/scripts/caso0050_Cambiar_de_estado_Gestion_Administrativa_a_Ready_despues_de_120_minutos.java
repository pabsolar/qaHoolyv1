...
public class caso0050_Cambiar_de_estado_Gestion_Administrativa_a_Ready_despues_de_120_minutos {
	...
	String Caso = "caso0050_Cambiar_de_estado_Gestion_Administrativa_a_Ready_despues_de_120_minutos";
	...
	public void cambioEstado() {
		...
		try {
			...
			Thread.sleep(200);
			System.out.println("Se selecciona el estado Gestión Administrativa");
			objCaller.btnGestionAdministrativa.click();
			tools.screenshot("scripts", Caso , "Ejecutivo en estado Gestión Administrativa");
			Thread.sleep(3000);
