...
public class caso0054_Actualizar_apellido_de_cliente_durante_llamada_formato_incorrecto {
	...
	String Caso = "caso0054_Actualizar_apellido_de_cliente_durante_llamada_formato_incorrecto";
	...
	public void modificarDatosClienteApeliido() {
		try {
			...
			objCaller.textApellidos.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.apellidoClienteFormatoDistinto);
