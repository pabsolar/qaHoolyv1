...
public class caso0104_Seleccionar_estado_Calificado_sin_ingresar_cierre_y_notas {
	...
	String Caso = "caso0104_Seleccionar_estado_Calificado_sin_ingresar_cierre_y_notas";
	...
	public void seleccionDeEstadoCierre() {
		try {
			objCaller.textRUT.sendKeys(variables.rutLeadCalificado);
			Thread.sleep(300);
			...
			objCaller.selEstado.sendKeys(variables.estadoCalificado);
			Thread.sleep(200);
			objCaller.selEstado.sendKeys(Keys.TAB);
			tools.screenshot("scripts", Caso , "Motivo de Cierre, Calificado");
			Thread.sleep(1000);
	...
	public void guardarDatos() {
		try {
			...
			tools.screenshot("scripts", Caso , "Cerrando Lead");
			Thread.sleep(300);
			System.out.println("Al no seleccionar" + " Motivo de Cierre" + " No habilita el botón Guradar datos");
			Thread.sleep(300);
			tools.screenshot("scripts", Caso , "No se pudo cerrar el Lead, ya que falta información");
			System.out.println("Se cierra el lead, esto no queda registrado");
			Thread.sleep(1000);
			objCaller.selMotivoCierre.sendKeys(variables.calificadoPerdido);
			Thread.sleep(300);
