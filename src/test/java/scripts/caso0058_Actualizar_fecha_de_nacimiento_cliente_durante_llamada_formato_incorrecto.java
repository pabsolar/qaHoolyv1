...
public class caso0058_Actualizar_fecha_de_nacimiento_cliente_durante_llamada_formato_incorrecto {
	...
	String Caso = "caso0058_Actualizar_fecha_de_nacimiento_cliente_durante_llamada_formato_incorrecto";
	...
	public void modificarDatosClienteFDN() {
		try {
			...
			Thread.sleep(300);
			objCaller.textFechaNacimiento.sendKeys(variables.fdnClienteFormatoDistinto);
