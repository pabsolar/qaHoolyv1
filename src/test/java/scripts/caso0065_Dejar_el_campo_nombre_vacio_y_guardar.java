...
public class caso0065_Dejar_el_campo_nombre_vacio_y_guardar {
	...
	String Caso = "caso0065_Dejar_el_campo_nombre_vacio_y_guardar";
	...
	public void modificarDatosClienteNombre() {
		try {
			...
			objCaller.textNombres.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.nombreClienteCampoVacio);
