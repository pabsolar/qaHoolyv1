...
public class caso0107_Seleccionar_Estado_No_Contactado_Ingresar_Nota_y_guardar {
	...
	String Caso = "caso0107_Seleccionar_Estado_No_Contactado_Ingresar_Nota_y_guardar";
	...
	public void seleccionDeEstadoCierre() {
		try {
			...
			objCaller.selEstado.sendKeys(variables.estadoNoContactado);
			Thread.sleep(200);
			objCaller.selEstado.sendKeys(Keys.TAB);
			tools.screenshot("scripts", Caso , "Motivo de Cierre, No Contactado");
			Thread.sleep(1000);
