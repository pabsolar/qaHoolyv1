...
public class caso0076_Re_enviar_SMS_a_telefono_modificado {
	...
	String Caso = "caso0076_Re_enviar_SMS_a_telefono_modificado";
	...
	@Test (priority = 6)
	public void enviarSMSTelefonoModificado() {
		objCaller = new pageCaller(tools.getDriver());
		try {
			System.out.println("Se envia SMS");
			Thread.sleep(200);
	...
	@Test (priority = 7)
	public void reEnviarSMSTelefonoModificado() {
		objCaller = new pageCaller(tools.getDriver());
		try {
			System.out.println("Se re - envia SMS");
			Thread.sleep(200);
