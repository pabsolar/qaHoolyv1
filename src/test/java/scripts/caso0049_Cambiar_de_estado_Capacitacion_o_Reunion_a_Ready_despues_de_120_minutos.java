...
public class caso0049_Cambiar_de_estado_Capacitacion_o_Reunion_a_Ready_despues_de_120_minutos {
	...
	String Caso = "caso0049_Cambiar_de_estado_Capacitacion_o_Reunion_a_Ready_despues_de_120_minutos";
	...
	public void cambioEstado() {
		...
		try {
			...
			Thread.sleep(200);
			System.out.println("Se selecciona el estado Capacitació - Reunión");
			objCaller.btnCapacitacionReunion.click();
			tools.screenshot("scripts", Caso , "Ejecutivo en estado Capacitació - Reunión");
			Thread.sleep(3000);
