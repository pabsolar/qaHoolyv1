...
public class caso0082_Actualizar_RUT_de_cliente_formato_incorrecto {
	...
	String Caso = "caso0082_Actualizar_RUT_de_cliente_formato_incorrecto";
	...
	public void modificarDatosClienteRUT() {
		try {
			...
			objCaller.textRUT.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.rutClienteFormatoDistinto);
