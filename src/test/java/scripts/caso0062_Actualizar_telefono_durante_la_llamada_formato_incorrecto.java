...
public class caso0062_Actualizar_telefono_durante_la_llamada_formato_incorrecto {
	...
	String Caso = "caso0062_Actualizar_telefono_durante_la_llamada_formato_incorrecto";
	...
	public void modificarDatosClienteTelefono() {
		try {
			...
			objCaller.textTelefono.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.telefonoClienteFormatoDistinto);
