...
public class caso0105_Seleccionar_estado_Abierto_Ingresar_Nota_y_guardar {
	...
	String Caso = "caso0105_Seleccionar_estado_Abierto_Ingresar_Nota_y_guardar";
	...
	public void seleccionDeEstadoCierre() {
		try {
			...
			tools.screenshot("scripts", Caso , "Motivo de Cierre, Abierto");
			Thread.sleep(1000);
