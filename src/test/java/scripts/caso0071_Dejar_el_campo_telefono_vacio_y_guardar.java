...
public class caso0071_Dejar_el_campo_telefono_vacio_y_guardar {
	...
	String Caso = "caso0071_Dejar_el_campo_telefono_vacio_y_guardar";
	...
	public void modificarDatosClienteTelefono() {
		try {
			...
			objCaller.textTelefono.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.telefonoClienteCampoVacio);
