...
public class caso0068_Dejar_el_campo_fecha_de_nacimiento_vacio_y_guardar {
	...
	String Caso = "caso0068_Dejar_el_campo_fecha_de_nacimiento_vacio_y_guardar";
	...
	public void modificarDatosClienteFDN() {
		try {
			...
			Thread.sleep(300);
			objCaller.textFechaNacimiento.sendKeys(variables.fdnClienteCampoVacio);
