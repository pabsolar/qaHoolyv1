...
public class caso0095_Dejar_el_campo_afp_actual_en_vacio_y_guardar {
	...
	String Caso = "caso0095_Dejar_el_campo_afp_actual_en_vacio_y_guardar";
	...
	public void modificarDatosClienteAfpActual() {
		try {
			...
			objCaller.selAFPActual.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.afpActualCampoVacio);
