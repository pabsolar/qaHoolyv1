...
public class caso0108_Seleccionar_estado_Cerrado_motivo_AFP_Licitada_sin_ingresar_nota_y_guardar {
	...
	String Caso = "caso0108_Seleccionar_estado_Cerrado_motivo_AFP_Licitada_sin_ingresar_nota_y_guardar";
	...
	public void seleccionDeEstadoCierre() {
		try {
			...
			objCaller.selEstado.sendKeys(variables.estadoCerrado);
			Thread.sleep(200);
	...
	public void agregarMotivo() {
		try {
			System.out.println("Se agrega motivo al Lead");
			tools.screenshot("scripts", Caso , "Agregando Motivo");
			Thread.sleep(100);
			objCaller.selMotivoCierre.sendKeys(variables.cierreAFPLicitada);
			tools.screenshot("scripts", Caso , "Se ha agreado motivo al Cierre");
			objCaller.selMotivoCierre.sendKeys(Keys.TAB);
			Thread.sleep(1000);
