...
public class caso0100_Seleccionar_estado_Contactado_sin_ingresar_notas_y_guardar {
	...
	String Caso = "caso0100_Seleccionar_estado_Contactado_sin_ingresar_notas_y_guardar";
	...
	public void seleccionDeEstadoCierre() {
		try {
			...
			objCaller.selEstado.sendKeys(variables.estadoContactado);
			Thread.sleep(200);
