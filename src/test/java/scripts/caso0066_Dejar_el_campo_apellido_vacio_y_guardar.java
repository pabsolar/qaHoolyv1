...
public class caso0066_Dejar_el_campo_apellido_vacio_y_guardar {
	...
	String Caso = "caso0066_Dejar_el_campo_apellido_vacio_y_guardar";
	...
	public void modificarDatosClienteApeliido() {
		try {
			...
			objCaller.textApellidos.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.apellidoClienteCampoVacio);
