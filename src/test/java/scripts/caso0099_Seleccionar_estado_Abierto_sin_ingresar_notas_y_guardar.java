...
public class caso0099_Seleccionar_estado_Abierto_sin_ingresar_notas_y_guardar {
	...
	String Caso = "caso0099_Seleccionar_estado_Abierto_sin_ingresar_notas_y_guardar";
	...
	public void seleccionDeEstadoCierre() {
		try {
			...
			objCaller.selEstado.sendKeys(variables.estadoAbierto);
			Thread.sleep(200);
