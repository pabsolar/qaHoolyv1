...
public class caso0052_Actualizar_nombre_de_cliente_durante_llamada_formato_incorrecto {
	...
	String Caso = "caso0052_Actualizar_nombre_de_cliente_durante_llamada_formato_incorrecto";
	...
	public void modificarDatosClienteNombre() {
		try {
			...
			objCaller.textNombres.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.nombreClienteFormatoDistinto);
