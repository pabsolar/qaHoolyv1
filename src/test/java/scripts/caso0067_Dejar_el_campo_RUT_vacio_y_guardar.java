...
public class caso0067_Dejar_el_campo_RUT_vacio_y_guardar {
	...
	String Caso = "caso0067_Dejar_el_campo_RUT_vacio_y_guardar";
	...
	public void modificarDatosClienteRUT() {
		try {
			...
			objCaller.textRUT.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.rutClienteCampoVacio);
