...
public class caso0063_ {
	...
	String _class = "caso0059_Actualizar_AFP_durante_llamada";
	String _method = "";
	...
	public void actualizarAFP() {
		...
		try {
			...
			tools.screenshot("scripts", Caso , "Llamada Activa");
			Thread.sleep(200);
			objCaller.selAFPActual.sendKeys("Habitat");
	...
	public void cerrarLead() {
		try {
			...
			objCaller.textNota.sendKeys("Mensaje de Prueba para notas");
			Thread.sleep(750);
