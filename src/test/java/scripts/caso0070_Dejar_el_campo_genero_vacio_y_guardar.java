...
public class caso0070_Dejar_el_campo_genero_vacio_y_guardar {
	...
	String Caso = "caso0070_Dejar_el_campo_genero_vacio_y_guardar";
	...
	public void modificarDatosClienteGenero() {
		try {
			...
			objCaller.selGenero.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.generoClienteCampoVacio);
