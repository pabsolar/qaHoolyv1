...
public class caso0072_Dejar_el_campo_email_vacio_y_guardar {
	...
	String Caso = "caso0072_Dejar_el_campo_email_vacio_y_guardar";
	...
	public void modificarDatosClienteCorreo() {
		try {
			...
			objCaller.textCorreo.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.mailClienteCampoVacio);
