...
public class caso0064_Actualizar_email_durante_la_llamada_formato_incorrecto {
	...
	String Caso = "caso0064_Actualizar_email_durante_la_llamada_formato_incorrecto";
	...
	public void modificarDatosClienteCorreo() {
		try {
			...
			objCaller.textCorreo.sendKeys(Keys.HOME, Keys.chord(Keys.SHIFT, Keys.END), variables.mailClienteFormatoDistinto);
